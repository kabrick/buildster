...
public class TemperatureConversions extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_temperature_conversions);

        value_area7 = (TextView)findViewById(R.id.value_area7);
        unit_area7 = (TextView)findViewById(R.id.unit_area7);
    ...
    public void unitClick(View view){
        ...
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(TemperatureConversions.this);
    ...
    public void calculateValues(View view){
        value = Integer.parseInt(value_area7.getText().toString());
        ConversionCalc c = new ConversionCalc();
        result = c.Temperature(value, unit);
        cel.setText(String.format(Locale.US, "%.2f", result[0]));
        fah.setText(String.format(Locale.US, "%.2f", result[1]));
        kel.setText(String.format(Locale.US, "%.2f", result[2]));
    }
