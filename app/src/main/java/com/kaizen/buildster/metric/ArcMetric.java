...
public class ArcMetric extends AppCompatActivity implements View.OnClickListener{

    TextView area, length, perimeter, arcRadius, arcAngle, userInput;
    double[] result;
    int radius, angle;
    String title;
    String clear = "C";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_arc_metric);

        arcRadius = (TextView)findViewById(R.id.arcRadius);
        arcAngle = (TextView)findViewById(R.id.arcAngle);
        area = (TextView)findViewById(R.id.arcArea);
        length = (TextView)findViewById(R.id.arcLength);
        perimeter = (TextView)findViewById(R.id.arcPerimeter);
    }
    ...
    public void calculateValues(View view){
        radius = Integer.parseInt(arcRadius.getText().toString());
        angle = Integer.parseInt(arcAngle.getText().toString());
        ConversionCalc c = new ConversionCalc();
        result = c.Arc(radius, angle);
        area.setText(String.format(Locale.US, "%.2f", result[0]));
        length.setText(String.format(Locale.US, "%.2f", result[1]));
        perimeter.setText(String.format(Locale.US, "%.2f", result[2]));
    }
    ...
    public void valueCreate(){
        arcRadius.setText(title);
    }

    public void valueCreate2(){
        arcAngle.setText(title);
    }
}
