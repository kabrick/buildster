...
public class CubeMetric extends AppCompatActivity implements View.OnClickListener{

    TextView area, edge, volume, userInput;
    double[] result;
    int edge1;
    String title;
    String clear = "C";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cube_metric);

        edge = (TextView)findViewById(R.id.edge);
        area = (TextView)findViewById(R.id.cubeArea);
        volume = (TextView)findViewById(R.id.cubeVolume);
    }
    ...
    public void calculateValues(View view){
        edge1 = Integer.parseInt(edge.getText().toString());
        ConversionCalc c = new ConversionCalc();
        result = c.Cube(edge1);
        area.setText(String.format(Locale.US, "%.2f", result[0]));
        volume.setText(String.format(Locale.US, "%.2f", result[1]));
    }
